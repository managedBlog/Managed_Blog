<#
Name: Create-NewKeyVault
Author: Sean Bulger, twitter @managed_blog, http://managed.modernendpoint.com
Version: 1.0
.Synopsis
   Creates a new Azure Key Vault with a specified name. 
.DESCRIPTION
   Create-NewKeyVault is a script designed to allow an administrator to quickly create a new Azure Key Vault. If the -CreateNewResource value is set to True, a new resource group will also be created. The administrator can also pass in the Subscription, region,
